...
ax1.plot(chan, spectrum, label='Data', color='black', lw=1.5)
ax1.plot(chan, model1, label = r'$\alpha=$'+str(alpha1), color='purple', lw=2.)
...
ax2.plot(chan, spectrum, label='Data', color='black', lw=1.5)
ax2.plot(chan, model2, label = r'$\alpha=$'+str(alpha2), color='purple', lw=2.)
...
ax3.plot(chan, spectrum, label='Data', color='black', lw=1.5)
ax3.plot(chan, model3, label = r'$\alpha=$'+str(alpha3), color='purple', lw=2.)
